...
distance = [2.3, 0.55, 17.8, 65.8, 26.6, 30.3, 25.6, 34.4, 35.9, 21.3]
time = [10, 2, 54, 107, 52, 64, 54, 73, 66, 46]
...
recomend() #use the input to generate list of recomendation
